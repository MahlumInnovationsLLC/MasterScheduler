    ...
    <div className="resizable-bay-schedule relative flex flex-col h-full dark">
      ...
      <div className="flex flex-row flex-1 h-full">
        ...
        <div className="bay-schedule-viewport flex-grow overflow-auto" ref={viewportRef}>
          {/* First add a container for the sticky header */}
          <div className="sticky-header-container sticky top-0 z-50 bg-gray-900 shadow-md">
            {/* Timeline Header */}
          ...
          {/* Hide original timeline header since we moved it to the sticky container */}
          <div className="timeline-header hidden flex" 
            style={{ 
