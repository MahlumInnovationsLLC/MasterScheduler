...
const Sidebar = () => {
  ...
  return (
    <aside className={`bg-darkCard border-r border-gray-800 h-screen overflow-y-auto pt-16 transition-all duration-300 fixed left-0 top-0 z-[5] ${isCollapsed ? 'w-[50px]' : 'w-[260px]'}`}>
      {/* Toggle Button - positioned outside of scrolling area */}
      <button 
        className="absolute top-12 -right-4 bg-primary hover:bg-primary-dark text-white rounded-full p-2 shadow-lg z-20 border border-gray-700"
