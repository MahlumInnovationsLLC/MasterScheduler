...
const BaySchedulingPage = () => {
  ...
  return (
    <div className="px-4 py-4 md:py-6 md:px-6">
      {/* Notification about pixel-perfect positioning update - May 16, 2025 */}
      <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 mb-4 rounded-md shadow-sm">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-blue-800 dark:text-blue-200">
              Precision Placement Update (May 16, 2025)
            </h3>
            <div className="mt-1 text-sm text-blue-700 dark:text-blue-300">
              <p>Projects will now stay <span className="font-bold">exactly</span> where you drop them with no automatic repositioning. Multiple projects can now overlap in the same row, providing greater precision for schedule management.</p>
            </div>
          </div>
        </div>
      </div>
